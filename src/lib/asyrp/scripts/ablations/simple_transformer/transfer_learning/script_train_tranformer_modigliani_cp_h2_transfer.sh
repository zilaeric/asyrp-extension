...
python main.py  --run_train                     \
                --config $config                \
                --exp ../../runs/transfer_abl_transf_pc_h2_$guid          \
                --manual_checkpoint_name ../../ablation_checkpoints/nheads/h2/heads_abl_transf_pc_h2_l1_d2048_pixar_LC_CelebA_HQ_t999_ninv40_ngen40_5.pth \
                --edit_attr $guid               \
                --do_train 1                    \
                --do_test 0                     \
                --bs_train 9                    \
